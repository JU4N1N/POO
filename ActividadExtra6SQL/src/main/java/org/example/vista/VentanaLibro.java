...
public class VentanaLibro extends JFrame {
    ...
    private JPanel panel1; // formularió para capturar libros
    private JPanel panel2; // tabla para mostrar los libros de base de datos
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(218, 74, 74));
        lblId = new JLabel("Id: ");
        ...
        panel2.setBackground(new Color(107, 211, 72));
        ...
        panel3.setBackground(new Color(18, 133, 125));


        //Panel4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(173, 80, 232));
